...
@Injectable()
export class ClassAlertResourceService {
   ...
   */
  public searchAlertClasses(
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<Array<AlertClass>>;
  public searchAlertClasses(
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<Array<AlertClass>>>;
  public searchAlertClasses(
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<AlertClass>>>;
  public searchAlertClasses(
    observe: any = 'body',
    ...
    return this.httpClient.get<Array<AlertClass>>(
      `${this.basePath}/alert-classes`,
      {
